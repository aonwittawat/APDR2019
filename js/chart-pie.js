...
var myPieChart = new Chart(ctx, {
    type: 'doughnut',    
    data: {
      labels: ['Drought', 'Earthquake', 'Tropical Cyclone', 'Tsunami', 'Flood', 'Multi-Hazard'],
      datasets: [{
        data: [404479.16, 49947.40, 47276.63, 3308.89, 48332.76, 148865.68],
        backgroundColor: ['#6c000f', '#f93753', '#fa6511', '#0289c3', '#5ac9ff','#a6d81a']
      }]
    },
    options: {
      responsive: true,
